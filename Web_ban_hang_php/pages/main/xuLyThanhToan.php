<?php
  ...
  //$now = Carbon::now('Asia/Ho_Chi_Minh');
    ...
    //insert cart
    $insert_cart = "INSERT INTO tbl_giohang(id_khachhang,ma_gh,trang_thai,cart_date,cart_payment,cart_shipping) VALUE('".$id_khachhang."','".$ma_gh."',1,'".$now."','".$cart_payment."','".$cart_shipping."')";
      if($cart_query){
