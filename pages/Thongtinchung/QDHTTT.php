<div class="container_Info">
    <div class="infor">
        ...
        <p> <span class="Buoc">Bước 2:</span>Nhen.vn xác nhận đơn hàng</p>
        ...
        <p> <span class="Buoc">Bước 6:</span>Nhen.vn luôn chờ những phản hồi của khách hàng (nếu có) sau khi hoàn tất giao dịch.</p>
        <p class="Muclon">PHƯƠNG THỨC THANH TOÁN:</p>
        <p class="Demuc">1. Phương thức trả sau: thanh toán khi nhận hàng.</p>
        <p>
        <ul>
            <p>- Khách hàng có thể đặt hàng qua website Nhen.vn. Nhân viên cg ủa chúng tôi sẽ gọi điện xác nhận với khách hàng về sản phẩm và phương thức vận chuyển.</p>
        ...
        <p>
        <ul>
            <p>A. Thanh toán trực tuyến : thanh toán trực tiếp trên website Nhen.vn khi đặt đơn hàng bằng các loại thẻ Visa/Master/thẻ nội địa/ thẻ ghi nợ của tất cả các ngân hàng..</p>
        ...
        <p>Số tài khoản: 0071002888807</p>
        <p>Tên : Nguyễn Thùy Trâm</p>
